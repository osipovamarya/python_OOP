...
class Car(Transport):
    def __init__(self, brand, max_speed, mileage, gasoline_residue):
        super(Car, self).__init__(brand, max_speed, 'Car')
        self.mileage, self.__gasoline_residue = mileage, gasoline_residue
...
class Boat(Transport):
    def __init__(self, brand, max_speed, owners_name):
        super(Boat, self).__init__(brand, max_speed, 'Boat')
...
class Plane(Transport):
    def __init__(self, brand, max_speed, capacity):
        super(Plane, self).__init__(brand, max_speed, 'Plane')
